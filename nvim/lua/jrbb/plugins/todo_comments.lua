...
--
-- nnoremap("<leader>tt", ":TodoTrouble toggle focus=false win.position=right win.size=50 <cr>", { desc = "TodoTrouble", silent = true })
-- nnoremap("<leader>tf", ":TodoTelescope <cr>", { desc = "TodoTelescope", silent = true })
--
return {
--   {
